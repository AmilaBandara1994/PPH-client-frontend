...
@Component({
  selector: 'app-clinccountbyclinictype',
  templateUrl: './clinccountbyclinictype.component.html',
  styleUrls: ['./clinccountbyclinictype.component.css']
})
export class ClinccountbyclinictypeComponent {
  selected = 'monthly';
